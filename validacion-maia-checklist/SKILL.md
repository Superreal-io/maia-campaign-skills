...
description: 16 criterios de validacion del sistema MAIA. Los usa el Campaign Manager en Cierre como capa de control de calidad transversal.
version: 2.0.0
owner: system
status: active
---
...
Cargada por el Campaign Manager. Define los 16 criterios de validacion que el Campaign Manager ejecuta en Cierre (post-Visual Designer) sobre el paquete completo de la campana.
...
### Cierre (post-Visual Designer, sobre el paquete completo)

El Campaign Manager evalua el paquete completo (brief + estrategia + estrategia creativa + mockups) contra estos 16 criterios:
...
| V11 | Contradicciones entre canales | No hay mensajes contradictivos entre canales ni canibalizacion evidente. | Analisis cross-canal |
...
| V16 | Tesis estrategica | La `tesis_estrategica` de C es coherente con la `idea_dominante` de B y el `objetivo_comunicacion` del brief. Todos los territorios de campana se conectan con la tesis. | campaign-output-format, golden-briefing-schema |
