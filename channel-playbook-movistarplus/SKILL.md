...
### Presion recomendada
Baja. El banner debe integrarse visualmente con la interfaz. Frecuencia controlada: no mas de un banner comercial visible simultaneamente en la experiencia principal. Rotacion con contenido editorial nativo de la plataforma.
...
### Presion recomendada
Media-alta en relevancia, baja en frecuencia. Cada preroll debe superar un umbral minimo de pertinencia. No repetir la misma pieza mas de dos veces por semana al mismo usuario. Priorizar campanas con conexion directa al tipo de contenido consumido.
...
### Presion recomendada
Muy baja en frecuencia, muy alta en calidad. Reservar para un maximo de una o dos activaciones al mes. Cada First Impression debe ser una pieza que el cliente recuerde como positiva. Si no cumple ese criterio, no merece este formato.
...
### Adecuado para
- Territorios de marca Movistar (seguridad, atencion, confianza).
...
### Riesgo principal
Convertir la publicidad lineal en performance de bajo contexto. Este formato no es para promociones tacticas, codigos de descuento ni mensajes que requieren respuesta directa. Funciona construyendo, no empujando.

### Presion recomendada
Media. Frecuencia coherente con el plan de medios general. Evitar saturacion de bloques con multiples piezas Movistar consecutivas. Alternar con contenido editorial y promo de la propia plataforma.
...
1. **Saturacion del canal.** M+ es canal propio, lo que da control total pero tambien responsabilidad total. Cualquier saturacion se refleja directamente en NPS de la plataforma.
2. **Desconexion entre mensaje y contexto.** Un mensaje de fibra en un bloque de cine infantil no solo no funciona: irrita.
3. **Frecuencia acumulada.** El cliente puede recibir impactos en banner, preroll y lineal en la misma sesion. La presion total debe gestionarse como un conjunto, no por formato aislado.
...
5. **Uso de formatos premium para mensajes menores.** First Impression y preroll tienen un coste de atencion alto para el cliente. Usarlos para mensajes que no lo merecen quema el formato para futuras activaciones.
...
- [ ] La segmentacion se siente relevante, no intrusiva.
- [ ] La pieza es audiovisual de verdad (emocion, imagen, movimiento), no texto disfrazado.
